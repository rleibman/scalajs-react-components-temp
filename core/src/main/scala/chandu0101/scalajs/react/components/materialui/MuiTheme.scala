...
object MuiPalette {
  ...
  implicit class MuiPaletteOps(p: MuiPalette) {
    def copy(
      primary1Color: MuiColor = p.primary1Color,
      ...
      disabledColor: MuiColor = p.disabledColor
    ): MuiPalette =
      js.Dynamic.literal(
        primary1Color = primary1Color,
        primary2Color = primary2Color,
...
object MuiRawTheme {
  ...
  implicit class MuiRawThemeOps(t: MuiRawTheme) {
    def copy(
      spacing: MuiSpacings = t.spacing,
      fontFamily: String = t.fontFamily,
      palette: MuiPalette = t.palette
    ): MuiRawTheme =
      js.Dynamic.literal(
        spacing = spacing,

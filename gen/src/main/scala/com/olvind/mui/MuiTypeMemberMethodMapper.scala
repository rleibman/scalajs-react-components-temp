...
object MuiTypeMemberMethodMapper extends MemberMapper {
  ...
  private def apply(c: CompName, args: Seq[String], m: String) =
    (c.value, args.size, m) match {
      ...
      case ("ListItem", 3, "createTextElement") => "createTextElement(styles: CssProperties, data: js.Any, key: String): Unit"
      ...
      case ("Menu", 4, "cloneMenuItem") => "cloneMenuItem(child: js.Any, childIndex: Int, styles: CssProperties, index: Int): Unit"
      ...
      case ("Menu", 2, "isChildSelected") => "isChildSelected(child: js.Any, props: js.Any): Boolean"
      ...
      case ("Popover", 5, "applyAutoPositionIfNeeded") => "applyAutoPositionIfNeeded(anchor: js.Any, target: js.Any, targetOrigin: js.Any, anchorOrigin: js.Any, targetPosition: js.Any): Unit"
      case ("Popover", 1, "autoCloseWhenOffScreen") => "autoCloseWhenOffScreen(anchorPosition: js.Any): Unit"
      case ("Popover", 1, "getAnchorPosition") => "getAnchorPosition(): Position"
      case ("Popover", 3, "getOverlapMode") => "getOverlapMode(anchor: js.Any, target: js.Any, median: js.Any): Unit"
      ...
      case ("Popover", 1, "requestClose") => "requestClose(reason: String): Unit" //clickaway or offScren
      ...
      case ("RadioButtonGroup", 1, "hasCheckAttribute") => "hasCheckAttribute(radioButton: js.Any): Boolean"
      case ("RadioButtonGroup", 1, "updateRadioButtons") => "updateRadioButtons(newSelection: js.Any): Unit"
      ...
      case ("TableHeader", 1, "getSelectAllCheckboxColumn") => "getSelectAllCheckboxColumn(): Unit" //TODO
